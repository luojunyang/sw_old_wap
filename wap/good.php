...
if(in_array($product_id,$onlygoods_id)){
    redirect('./yws_onlygoods.php?id='.$product_id);
}
...
//	}
//}$price_back = returnCash($nowProduct['price']);
...
logs(var_export($share_conf,true),'sharegoods');
import('WechatShare');
