...
<header class="index-head">
	<?php
	echo '<a class="logo" href="./yws_ydy.php">';
...
<div class="wx_wrap" style="display:none">
	...
	<div id="yScroll2" style="overflow:hidden;position:absolute;top:50px;left:76px;">
		<div class="swiper-container2" style="padding:0 10px 10px 10px;overflow: hidden;">
            <div class="right-top">
                <a href="http://www.yunwenshang.com/wap/yws_onlyOne.php">
                    <img width="100%" height="100%" src="http://www.yunwenshang.com/template/wap/default/css/images/onlyone_adv.jpg" alt="">
                </a>
            </div>
