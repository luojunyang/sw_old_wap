...
<!--                <link rel="stylesheet" href="--><?php //echo TPL_URL ?><!--css/comment.css"/>-->
        <link rel="stylesheet" href="<?php echo TPL_URL; ?>css/goods.css"/>
<!--        <link rel="stylesheet" href="--><?php //echo TPL_URL; ?><!--css/yws_lz/onlyone.css"/>-->
...
<!--                <div class="old-price">￥--><?//= $nowProduct['market_price']?><!--</div>-->
                <div class="sale-count"><?php echo empty($sum) ? 0 : $sum?>笔销量</div>
            </div>
        </div>
        ...
        <hr/>
        <!--产品摘要-->
        <div id="pro-intro " class="sku-detail" >
            <?php
            if ($newPropertyList) {
            ...
            <ul style="padding: 10px;">
                ...
                <li>
                    <span>供应商：</span>
                    <span style="color:red">云温商官方</span>
                    <span style="float: right;"><a href="./yws_ydy.php">进入</a></span>
                </li>
            </ul>
        </div>
        <hr/>
