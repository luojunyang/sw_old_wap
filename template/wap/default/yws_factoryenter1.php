    ...
    <div class="section section3">
      <div class="con-con-box">
          ...
          <div class="showbox" style="font-size: 12px;">
              ...
              <ul>
                  <li>
                      <label><input type="radio" name="type" value="1" id="type2">
                          国外商家</label>
                  </li>
              </ul>
              <form action="./yws_factoryenter.php" name="type1" method="get" id="cjrzfrom1">
                  <input type="hidden" value="1" name="contry">
                  <ul id="select1">
                      <li>
              ...
              <form action="./yws_factoryenter.php" name="type2" method="get" id="cjrzfrom2">
                  <input type="hidden" value="2" name="contry">
                  <ul id="select2">
                      <li>
                          <label>
                      ...
                      <li>
                          <label>
                              <input type="checkbox" name="mold4" value="list2,list4,list6" id="liquor2">
                              &nbsp;&nbsp;&nbsp;经营进口酒类;
                          </label>
                      </li>
                      <li>
