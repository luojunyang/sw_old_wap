	...
	$.post('./goodinfo.php', {action: 'getSku', product_id: product_id}, function (result) {
		...
		switch (buyType) {
			case 0:
				...
				break;
			case 1:
				skuHtml += '<a href="javascript:;" class="js-mutiBtn-confirm confirm btn btn-block btn-orange-dark">提交</a>';
				break;
			default:
