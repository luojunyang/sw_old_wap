...
<title>
        <?php echo $nowOrder['status_txt']; ?>的订单
</title>
...
//						else {
                            ...
                            if(isset($only_res)){
                                if($my_code==2){
                                    echo "已开奖 | 开奖号：<span style='color: red;'>{$codeNumber}</span>";
                                    echo '<h4 style="text-align: center;color: red;">恭喜您，中奖了。</h4>';
                                }else if($my_code==1){
                                    echo "已开奖 | 开奖号：<span style='color: red;'>{$codeNumber}</span>";
                                    echo '<h4 style="text-align: center;color: red;">还差一丢丢...</h4>';
                                }else{
                                    echo "待开奖";
                                }
                            }else{
...
//						}
				...
				<div class="block block-order block-border-top-none">
                    ...
                    <?php if(isset($only_res)):?>
                        <div class="bottom">幸运号：
                            <span class="c-orange pull-right">
                                <?= $number_str?>
                            </span>
                        </div>
                    <?php endif;?>
