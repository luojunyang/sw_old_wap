...
<!--            <a href="#" class="count-a">-->
        ...
        <div class="small-6 large-3 columns mid" style="width:50%; float: left;">
            ...
            <a href="#" class="count-a">
                ...
                <span class="count-title">我的积分</span>
            </a>
        </div>
    </div>
...
<!--            <li class="tiao"><a href="./yws_share.php">-->
    ...
    <ul class="my_list">
        ...
        <li class="tiao">
            <a href="javascript:;" onclick="window.location.href='./balance.php?a=recharge'"><img src="<?php echo TPL_URL; ?>images/tb/congzhi.png" alt="">账户充值</a>
        </li>
        <li class="tiao">
            <a href="./balance.php?a=exchange"><img src="<?php echo TPL_URL; ?>images/tb/jifen.png" alt="">积分兑换余额</a>
        </li>
        <li class="hr"></li>
        ...
        if ($store_status) { ?>
            <li class="tiao">
                <a href="<?php echo $store_approve==0?'javascript:;':'./yws_store_home.php?store_id='.$store['store_id']?>">
                    <img src="<?php echo TPL_URL; ?>images/tb/bwdj.png" alt="">我的商城
                    <?php if(!$store_approve) {?>
                        <span class="pull-right" style="top:4px; color: red;">认证中</span>
                    <?php }?>
                </a>
            </li>
            <?php
            ...
            <li class="tiao">
                <a href="./yws_agent_apply.php">
                    <img src="<?php echo TPL_URL; ?>images/tb/bwdj.png" alt="">申请微商城
                </a>
            </li>
        <?php
        } ?>
