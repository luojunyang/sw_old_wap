    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var noCart = true,
                ...
                storeUrl = 'http://www.yunwenshang.com/wap/category2.php?boom=1',
...
<!--                <a href="http://www.yun-ws.com/waplogin">浏览记录</a>-->
            </div>
                                ...
                                <div class="name-card name-card-3col clearfix">
                                    <a href="./good.php?id=<?php echo $value['product_id']; ?>" class="thumb"><img
                                            ...
                                            <p class="ellipsis">
                                                <?php if ($value['sku_data']) {
                                                    ...
                                                    foreach ($sku_data_arr as $v) { ?>
                                                        <span class="c-gray ellipsis"><?php echo $v['name']; ?>
                                                            ：<?php echo $v['value']; ?></span>
                                                    <?php }
                                                } ?>
                                            </p>
                                        </div>
                                        ...
                                        <div class="right-col price-num">
                                            ...
                                            <div class="num<?php if (!empty($value['buyer_quota'])) {
                                                echo ' buyer-quota';
                                            } ?>" <?php if (!empty($value['buyer_quota'])) {
                                                echo 'data-buyer-quota="' . $value['buyer_quota'] . '" data-buy-quantity="' . $value['buy_quantity'] . '"';
