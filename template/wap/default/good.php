<?php if (!defined('TWIKER_PATH')) exit('deny access!'); ?>
    ...
    <head>
        ...
        <script> var storeId =<?php echo $now_store['store_id'];?>,yws_create=false , product_id =<?php echo $nowProduct['product_id'];?>, showBuy = !!<?php echo intval($_GET['buy'])?>, hasActivity = !!<?php echo intval($nowActivity);?>, activityId =<?php echo intval($nowActivity['id']);?>, activityType =<?php echo intval($nowActivity['type']);?>, activityDiscount =<?php echo floatval($nowActivity['discount']);?>, activityPrice =<?php echo floatval($nowActivity['price']);?>;</script>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="js-mp-info share-mp-info">
                ...
                <div class="links"><a class="mp-homepage" href="./my_recently.php">我的记录</a></div>
            </div>
            <!-- ▲顶部通栏 -->
        </div>
        <div class="content">
            <div class="content-body">
                ...
                <div class="goods-header">
                    ...
                    <div class="goods-price">
                        ...
                        <?php } ?>
                        <?php if($price_back):?>
                            <span class="price_back" style="float:right;font-size: 15px;margin-right: 5%;">购买立返 <em style="color: red;font-size: 16px;"><?= $price_back?></em> 元</span>
                        <?php endif;?>
                    </div>
                </div>
...
/*                                    if ($nowProduct['point'] == 0) {
                        ...
                        <div class="qrcode-buy"><a href="javascript:;" class="js-qrcode-buy btn btn-block btn-orange-dark butn-qrcode">立即购买</a>
                        </div>
                    </div>
                <?php } ?>
                <div class="js-components-container components-container">
                    <div class="custom-store">
                        <!--<a class="custom-store-link clearfix" href="./?ywsydy=true">-->
