            ...
            <ul>
                <?php if(!empty($cat_ids)):?>
                    <?php foreach ($cat_ids as $v):?>
                        <li>
                            <a href="./category2.php?cat_ids=<?php echo trim($v['ids'],',')?>">
                                <span style="font-size: 12px;color: white;text-align: center;"><img width="50" src="<?php echo $v['cat_pic']?>" alt=""><?php echo $v['name']?></span>
                            </a>
                        </li>
                    <?php endforeach;?>
                <?php endif;?>
