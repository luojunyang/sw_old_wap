...
class WechatShare
{
    ...
    public function getSginAndlocation($share_conf)
    {
        import('WechatApi');
        $tokenObj = new WechatApi(array('appid' => $this->appid, 'appsecret' => $this->appsecret));
        $access_token = $tokenObj->get_access_token();
        ...
        $share_html = $this->getLocationAndShare($sign_data, $share_conf);
    ...
    /*获取地理位置*/
    public function getLocationAndShare($sign_data,$share_conf)
    {
	  ...
	  wx.getLocation({
            ...
            success: function (res) {
               ...
               /* alert(addComp.province + "," + addComp.city + "," + addComp.district +"," + addComp.street +"," + addComp.streetNumber);*/
                $('#demo').val(addComp.province+","+addComp.city+","+addComp.district);
            });
        }
        //map_click(latitude,longitude);
