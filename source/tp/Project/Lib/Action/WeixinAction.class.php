...
class WeixinAction extends Action
{
    ...
    public function index()
    {
        ...
        file_put_contents('./sw_weixin.txt',json_encode($data));
        //file_put_contents('./sw_weixintype.txt',$type);
        //file_put_contents('./sw_weixincontent.txt',$content);
...
//		$mer_id = 0;
        //file_put_contents('./sw_weixin.txt',$id);
        if ($data['MsgType'] == 'event') {
            ...
            switch (strtoupper($data['Event'])) {
                case 'SCAN':
                    file_put_contents('./sw_weixin.txt',1);
                    // tpl qrcode
...
//					$this->route();
            ...
            file_put_contents('./sw_weixin.txt','text');
