...
function getAttachmentUrl($fileUrl, $is_remote = true)
{
    if (empty($fileUrl)) {
        ...
        //dump(option('config.site_url'));
        //$url = 'http://www.yunwenshang.com/upload/';
...
function returnCash($total_money)
{
    if($total_money>=10000){
        $return_money = 500;
    }elseif ($total_money>=5000){
        $return_money = 200;
    }elseif ($total_money>=2000){
        $return_money = 80;
    }elseif ($total_money>=1000){
        $return_money = 60;
    }elseif ($total_money>=500){
        $return_money = 40;
    }elseif ($total_money>=300){
        $return_money = 20;
    }elseif ($total_money>=200){
        $return_money = 10;
    }elseif ($total_money>=100){
        $return_money = 3;
    }elseif ($total_money>=50){
        $return_money = 2;
    }elseif ($total_money>=20){
        $return_money = 1;
    }else{
        $return_money = 0;
    }
